...
+   These __lesion studies__ provide the foundation for much current
    understanding of the anatomy of neural systems, purposefully damaging a
    distinct brain region, nerve, or tract in an experimental animal and
    observing and documenting the subsequent loss of function in single or
    interconnected regions.

+   techniques to trace neural connections
    +   from their source to their termination (__anterograde__)
    +   from terminus to source (__retrograde__).

### Functional Analysis of Neural Systems

![electrophysiological recording in a monkey]({{ site.baseurl }}/images/bio-imgs/chapter1-6.png)

+   Diverse physiological methods are now available to evaluate the electrical
    and metabolic activity of the neuronal circuits that make up a neural
    system. Two approaches:
    +   __electrophysiological recording__
        +   most widely used: _single-cell, or single-unit,
            electrophysiological recording with micro electrodes_.
        +   often records from _several nearby cells_ in addition to
            _the one selected_, providing further useful information.
        +   __receptive field__ --- the region in sensory space within which a
            specific stimulus elicits action potential response.
    +   __functional brain imaging__
        +   has revolutionized both our understanding of neural systems and our
            ability to describe and diagnose functional abnormalities.
        +   _noninvasive_ and thus applicable to both clinical patients and
            normal human subjects.
        +   cannot resolve the electrical activity of _individual neurons_.
        +   does record the _local metabolic activity_ within small volumes of
            brain tissue.
        +   the simultaneous evaluation of multiple brain structures.

#### Brain Imaging Techniques

+   Computerized Tomography (CT)
    +   uses a _narrow X-ray beam_ and _a row of very sensitive detectors_
        placed on opposite sides of the head to probe a small portion of
        tissue at a time with limited radiation exposure.
    +   can readily distinguish _gray matter_ and _white matter_, differentiate
        the ventricles quite well, and show many other brain structures with
        a _spatial resolution of several millimeters_.

+   Magnetic Resonance Imaging (MRI)
    +   the nuclei of some atoms act as spinning magnets, and that if placed in
        a strong magnetic field these atoms will line up with the field and
        spin at a frequency that is dependent on the field strength.
    +   the magnetic field is distorted slightly by imposing magnetic gradients
        along three different spatial axes so that only nuclei at certain
        locations are tuned to the detector's frequency at  any given time.
    +   use detectors tuned to the radio frequencies of spinning
        _hydrogen nuclei_ in water molecules, creating images based on the
        distribution of water in different tissues.
    +   extraordinarily detailed spatial images of the brain at any location
        and orientation, with _sub-millimeter resolution_.
    +   The strong magnetic field and radio frequency pulses used in scanning
        are _harmless_, making this technique _completely noninvasive_.
    +   possible to visualize axon pathways using a _variant of MRI_ referred
        to as __diffusion tensor imaging (DTI)__

+   Functional Brain Imaging
    +   Positron Emission Tomography (PET)
        +   unstable positronemitting isotopes are incorporated into different
            reagents (including water, precursor molecules of specific
            neurotransmittem, or glucose) and injected into the bloodstream.
        +   to visualize activity-dependent changes in blood flow,
            tissue metabolism,, or biochemical activity
        +   a spatial resolution of about _4 mm_
    +   Single-photon Emission Computerized Tomography (SPECT)
        +   similar to PHT in that it involves injection or inhalation
            of radiolabeled compound
    +   Functional Magnetic Resonance Imaging (fMRI)
        +   the best approach for visualizing brain function based on local
            metabolism
        +   uses signals intrinsic to the brain without any radioactivity,
            repeated observations can be made on the same individual---a major
            advantage over imaging methods such as PET.
        +   The spatial resolution (_2-3 mm_) and temporal resolution
            (_a few seconds_) of fMRI are superior to PET and SPECT
        +   Magnetoencephalography (MEG)
            +   localize brain function with better temporal resolution.
            +   sometimes used to map changes in brain function with
                _millisecond resolution_.
            +   records the magnetic consequences of brain electric activity
                rather than the electrical signals themselves.
            +   can detect dynamic electrical activity in the brain with
                temporal resolution that approximates the key events
                in neuronal electrical signaling.

### Analyzing Complex Behavior

+   __Cognitive neuroscience__ devoted to understand more complex brain
    functions such as perception, language, emotion, memory, and consciousness.

+   __Neuroethology__ devoted to observing complex behaviors of animals in
    their native environment.

## Chapter 9 (page 198-207)
